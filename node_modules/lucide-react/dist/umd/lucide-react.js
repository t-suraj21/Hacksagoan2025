...
(function (global, factory) {
  ...
  const ALargeSmall = createLucideIcon("a-large-small", __iconNode$oX);
  ...
  const AlignHorizontalSpaceBetween = createLucideIcon("align-horizontal-space-between", __iconNode$oz);
  ...
  const AlignJustify = createLucideIcon("align-justify", __iconNode$oy);
  ...
  const AlignLeft = createLucideIcon("align-left", __iconNode$ox);
  ...
  const AlignRight = createLucideIcon("align-right", __iconNode$ow);
  ...
  const AlignStartHorizontal = createLucideIcon("align-start-horizontal", __iconNode$ov);
  ...
  const AlignStartVertical = createLucideIcon("align-start-vertical", __iconNode$ou);
  ...
  const AlignVerticalDistributeEnd = createLucideIcon("align-vertical-distribute-end", __iconNode$os);
  ...
  const AlignVerticalJustifyCenter = createLucideIcon("align-vertical-justify-center", __iconNode$oq);
  ...
  const AlignVerticalJustifyEnd = createLucideIcon("align-vertical-justify-end", __iconNode$op);
  ...
  const AlignVerticalJustifyStart = createLucideIcon("align-vertical-justify-start", __iconNode$oo);
  ...
  const AlignVerticalSpaceAround = createLucideIcon("align-vertical-space-around", __iconNode$on);
  ...
  const AlignVerticalSpaceBetween = createLucideIcon("align-vertical-space-between", __iconNode$om);
  ...
  const Ambulance = createLucideIcon("ambulance", __iconNode$ol);
  ...
  const Ampersand = createLucideIcon("ampersand", __iconNode$ok);
  ...
  const Ampersands = createLucideIcon("ampersands", __iconNode$oj);
  ...
  const Amphora = createLucideIcon("amphora", __iconNode$oi);
  ...
  const Anchor = createLucideIcon("anchor", __iconNode$oh);
  ...
  const Angry = createLucideIcon("angry", __iconNode$og);
  ...
  const Annoyed = createLucideIcon("annoyed", __iconNode$of);
  ...
  const Antenna = createLucideIcon("antenna", __iconNode$oe);
  ...
  const Anvil = createLucideIcon("anvil", __iconNode$od);
  ...
  const Aperture = createLucideIcon("aperture", __iconNode$oc);
  ...
  const AppWindowMac = createLucideIcon("app-window-mac", __iconNode$ob);
  ...
  const AppWindow = createLucideIcon("app-window", __iconNode$oa);
  ...
  const Apple = createLucideIcon("apple", __iconNode$o9);
  ...
  const ArchiveRestore = createLucideIcon("archive-restore", __iconNode$o8);
  ...
  const ArchiveX = createLucideIcon("archive-x", __iconNode$o7);
  ...
  const Archive = createLucideIcon("archive", __iconNode$o6);
  ...
  const Armchair = createLucideIcon("armchair", __iconNode$o5);

  const __iconNode$o4 = [
    ["path", { d: "M15 5H9", key: "1tp3ed" }],
    ["path", { d: "M15 9v3h4l-7 7-7-7h4V9z", key: "ncdc4b" }]
  ];
  const ArrowBigDownDash = createLucideIcon("arrow-big-down-dash", __iconNode$o4);

  const __iconNode$o3 = [["path", { d: "M15 6v6h4l-7 7-7-7h4V6h6z", key: "1thax2" }]];
  const ArrowBigDown = createLucideIcon("arrow-big-down", __iconNode$o3);

  const __iconNode$o2 = [
    ["path", { d: "M19 15V9", key: "1hci5f" }],
    ["path", { d: "M15 15h-3v4l-7-7 7-7v4h3v6z", key: "16tjna" }]
  ];
  const ArrowBigLeftDash = createLucideIcon("arrow-big-left-dash", __iconNode$o2);

  const __iconNode$o1 = [["path", { d: "M18 15h-6v4l-7-7 7-7v4h6v6z", key: "lbrdak" }]];
  const ArrowBigLeft = createLucideIcon("arrow-big-left", __iconNode$o1);

  const __iconNode$o0 = [
    ["path", { d: "M5 9v6", key: "158jrl" }],
    ["path", { d: "M9 9h3V5l7 7-7 7v-4H9V9z", key: "1sg2xn" }]
  ];
  const ArrowBigRightDash = createLucideIcon("arrow-big-right-dash", __iconNode$o0);

  const __iconNode$n$ = [["path", { d: "M6 9h6V5l7 7-7 7v-4H6V9z", key: "7fvt9c" }]];
  const ArrowBigRight = createLucideIcon("arrow-big-right", __iconNode$n$);

  const __iconNode$n_ = [
    ["path", { d: "M9 19h6", key: "456am0" }],
    ["path", { d: "M9 15v-3H5l7-7 7 7h-4v3H9z", key: "1r2uve" }]
  ];
  const ArrowBigUpDash = createLucideIcon("arrow-big-up-dash", __iconNode$n_);
  ...
  const ArrowDownNarrowWide = createLucideIcon("arrow-down-narrow-wide", __iconNode$nT);

  const __iconNode$nS = [
    ["path", { d: "m7 7 10 10", key: "1fmybs" }],
    ["path", { d: "M17 7v10H7", key: "6fjiku" }]
  ];
  const ArrowDownRight = createLucideIcon("arrow-down-right", __iconNode$nS);
  ...
  const ArrowLeftToLine = createLucideIcon("arrow-left-to-line", __iconNode$nJ);

  const __iconNode$nI = [
    ["path", { d: "m12 19-7-7 7-7", key: "1l729n" }],
    ["path", { d: "M19 12H5", key: "x3x0zl" }]
  ];
  const ArrowLeft = createLucideIcon("arrow-left", __iconNode$nI);
  ...
  const ArrowUp01 = createLucideIcon("arrow-up-0-1", __iconNode$nD);
  ...
  const ArrowUp10 = createLucideIcon("arrow-up-1-0", __iconNode$nC);
  ...
  const ArrowUpFromDot = createLucideIcon("arrow-up-from-dot", __iconNode$nz);
  ...
  const ArrowUpFromLine = createLucideIcon("arrow-up-from-line", __iconNode$ny);

  const __iconNode$nx = [
    ["path", { d: "M7 17V7h10", key: "11bw93" }],
    ["path", { d: "M17 17 7 7", key: "2786uv" }]
  ];
  const ArrowUpLeft = createLucideIcon("arrow-up-left", __iconNode$nx);
  ...
  const ArrowUpNarrowWide = createLucideIcon("arrow-up-narrow-wide", __iconNode$nw);

  const __iconNode$nv = [
    ["path", { d: "M7 7h10v10", key: "1tivn9" }],
    ["path", { d: "M7 17 17 7", key: "1vkiza" }]
  ];
  const ArrowUpRight = createLucideIcon("arrow-up-right", __iconNode$nv);
  ...
  const ArrowUpToLine = createLucideIcon("arrow-up-to-line", __iconNode$nu);
  ...
  const ArrowUpWideNarrow = createLucideIcon("arrow-up-wide-narrow", __iconNode$nt);
  ...
  const ArrowUpZA = createLucideIcon("arrow-up-z-a", __iconNode$ns);

  const __iconNode$nr = [
    ["path", { d: "m5 12 7-7 7 7", key: "hav0vg" }],
    ["path", { d: "M12 19V5", key: "x0mq9r" }]
  ];
  const ArrowUp = createLucideIcon("arrow-up", __iconNode$nr);
  ...
  const ArrowsUpFromLine = createLucideIcon("arrows-up-from-line", __iconNode$nq);
  ...
  const Asterisk = createLucideIcon("asterisk", __iconNode$np);

  const __iconNode$no = [
    ["circle", { cx: "12", cy: "12", r: "4", key: "4exip2" }],
    ["path", { d: "M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4 8", key: "7n84p3" }]
  ];
  const AtSign = createLucideIcon("at-sign", __iconNode$no);
  ...
  const Atom = createLucideIcon("atom", __iconNode$nn);
  ...
  const AudioLines = createLucideIcon("audio-lines", __iconNode$nm);
  ...
  const AudioWaveform = createLucideIcon("audio-waveform", __iconNode$nl);
  ...
  const Award = createLucideIcon("award", __iconNode$nk);
  ...
  const Axe = createLucideIcon("axe", __iconNode$ni);
  ...
  const Baby = createLucideIcon("baby", __iconNode$nh);
  ...
  const Backpack = createLucideIcon("backpack", __iconNode$ng);
  ...
  const BadgeAlert = createLucideIcon("badge-alert", __iconNode$nf);
  ...
  const BadgeCent = createLucideIcon("badge-cent", __iconNode$ne);
  ...
  const BadgeCheck = createLucideIcon("badge-check", __iconNode$nd);
  ...
  const BadgeDollarSign = createLucideIcon("badge-dollar-sign", __iconNode$nc);
  ...
  const BadgeEuro = createLucideIcon("badge-euro", __iconNode$nb);
  ...
  const BadgeHelp = createLucideIcon("badge-help", __iconNode$na);
  ...
  const BadgeIndianRupee = createLucideIcon("badge-indian-rupee", __iconNode$n9);
  ...
  const BadgeInfo = createLucideIcon("badge-info", __iconNode$n8);
  ...
  const BadgeJapaneseYen = createLucideIcon("badge-japanese-yen", __iconNode$n7);
  ...
  const BadgeMinus = createLucideIcon("badge-minus", __iconNode$n6);
  ...
  const BadgePercent = createLucideIcon("badge-percent", __iconNode$n5);
  ...
  const BadgePlus = createLucideIcon("badge-plus", __iconNode$n4);
  ...
  const BadgePoundSterling = createLucideIcon("badge-pound-sterling", __iconNode$n3);
  ...
  const BadgeRussianRuble = createLucideIcon("badge-russian-ruble", __iconNode$n2);
  ...
  const BadgeSwissFranc = createLucideIcon("badge-swiss-franc", __iconNode$n1);
  ...
  const BadgeX = createLucideIcon("badge-x", __iconNode$n0);
  ...
  const Badge = createLucideIcon("badge", __iconNode$m$);
  ...
  const BaggageClaim = createLucideIcon("baggage-claim", __iconNode$m_);
  ...
  const BellDot = createLucideIcon("bell-dot", __iconNode$mz);
  ...
  const BellElectric = createLucideIcon("bell-electric", __iconNode$my);
  ...
  const BellMinus = createLucideIcon("bell-minus", __iconNode$mx);
  ...
  const BellOff = createLucideIcon("bell-off", __iconNode$mw);
  ...
  const BellPlus = createLucideIcon("bell-plus", __iconNode$mv);
  ...
  const BellRing = createLucideIcon("bell-ring", __iconNode$mu);
  ...
  const Bell = createLucideIcon("bell", __iconNode$mt);
  ...
  const BetweenHorizontalEnd = createLucideIcon("between-horizontal-end", __iconNode$ms);
  ...
  const BetweenHorizontalStart = createLucideIcon("between-horizontal-start", __iconNode$mr);
  ...
  const BetweenVerticalEnd = createLucideIcon("between-vertical-end", __iconNode$mq);
  ...
  const BetweenVerticalStart = createLucideIcon("between-vertical-start", __iconNode$mp);
  ...
  const BicepsFlexed = createLucideIcon("biceps-flexed", __iconNode$mo);
  ...
  const Bike = createLucideIcon("bike", __iconNode$mn);
  ...
  const Binary = createLucideIcon("binary", __iconNode$mm);
  ...
  const Binoculars = createLucideIcon("binoculars", __iconNode$ml);
  ...
  const Biohazard = createLucideIcon("biohazard", __iconNode$mk);
  ...
  const Bird = createLucideIcon("bird", __iconNode$mj);
  ...
  const Bitcoin = createLucideIcon("bitcoin", __iconNode$mi);

  const __iconNode$mh = [
    ["circle", { cx: "9", cy: "9", r: "7", key: "p2h5vp" }],
    ["circle", { cx: "15", cy: "15", r: "7", key: "19ennj" }]
  ];
  const Blend = createLucideIcon("blend", __iconNode$mh);
  ...
  const Blinds = createLucideIcon("blinds", __iconNode$mg);
  ...
  const Blocks = createLucideIcon("blocks", __iconNode$mf);
  ...
  const BluetoothConnected = createLucideIcon("bluetooth-connected", __iconNode$me);
  ...
  const BluetoothOff = createLucideIcon("bluetooth-off", __iconNode$md);
  ...
  const BluetoothSearching = createLucideIcon("bluetooth-searching", __iconNode$mc);

  const __iconNode$mb = [["path", { d: "m7 7 10 10-5 5V2l5 5L7 17", key: "1q5490" }]];
  const Bluetooth = createLucideIcon("bluetooth", __iconNode$mb);
  ...
  const Bold = createLucideIcon("bold", __iconNode$m9);
  ...
  const Bomb = createLucideIcon("bomb", __iconNode$m8);
  ...
  const Bone = createLucideIcon("bone", __iconNode$m7);
  ...
  const BookA = createLucideIcon("book-a", __iconNode$m6);
  ...
  const BookAudio = createLucideIcon("book-audio", __iconNode$m5);
  ...
  const BookCheck = createLucideIcon("book-check", __iconNode$m4);
  ...
  const BookCopy = createLucideIcon("book-copy", __iconNode$m3);
  ...
  const BookDashed = createLucideIcon("book-dashed", __iconNode$m2);
  ...
  const BookDown = createLucideIcon("book-down", __iconNode$m1);
  ...
  const BookHeadphones = createLucideIcon("book-headphones", __iconNode$m0);
  ...
  const BookHeart = createLucideIcon("book-heart", __iconNode$l$);
  ...
  const BookImage = createLucideIcon("book-image", __iconNode$l_);
  ...
  const BowArrow = createLucideIcon("bow-arrow", __iconNode$lB);
  ...
  const Box = createLucideIcon("box", __iconNode$lA);
  ...
  const Boxes = createLucideIcon("boxes", __iconNode$lz);
  ...
  const BrainCircuit = createLucideIcon("brain-circuit", __iconNode$lw);
  ...
  const BrainCog = createLucideIcon("brain-cog", __iconNode$lv);
  ...
  const Brain = createLucideIcon("brain", __iconNode$lu);
  ...
  const BrickWallFire = createLucideIcon("brick-wall-fire", __iconNode$lt);
  ...
  const BrickWall = createLucideIcon("brick-wall", __iconNode$ls);
  ...
  const BriefcaseBusiness = createLucideIcon("briefcase-business", __iconNode$lr);
  ...
  const BriefcaseConveyorBelt = createLucideIcon("briefcase-conveyor-belt", __iconNode$lq);
  ...
  const Briefcase = createLucideIcon("briefcase", __iconNode$lo);
  ...
  const BringToFront = createLucideIcon("bring-to-front", __iconNode$ln);
  ...
  const BrushCleaning = createLucideIcon("brush-cleaning", __iconNode$lm);
  ...
  const Brush = createLucideIcon("brush", __iconNode$ll);
  ...
  const Bubbles = createLucideIcon("bubbles", __iconNode$lk);
  ...
  const BugPlay = createLucideIcon("bug-play", __iconNode$li);
  ...
  const Bug = createLucideIcon("bug", __iconNode$lh);
  ...
  const Building2 = createLucideIcon("building-2", __iconNode$lg);
  ...
  const Building = createLucideIcon("building", __iconNode$lf);
  ...
  const BusFront = createLucideIcon("bus-front", __iconNode$le);
  ...
  const Bus = createLucideIcon("bus", __iconNode$ld);
  ...
  const CableCar = createLucideIcon("cable-car", __iconNode$lc);
  ...
  const Cable = createLucideIcon("cable", __iconNode$lb);
  ...
  const CakeSlice = createLucideIcon("cake-slice", __iconNode$la);
  ...
  const Cake = createLucideIcon("cake", __iconNode$l9);
  ...
  const Calculator = createLucideIcon("calculator", __iconNode$l8);
  ...
  const Calendar1 = createLucideIcon("calendar-1", __iconNode$l7);
  ...
  const CalendarArrowDown = createLucideIcon("calendar-arrow-down", __iconNode$l6);
  ...
  const CalendarArrowUp = createLucideIcon("calendar-arrow-up", __iconNode$l5);
  ...
  const CalendarCheck2 = createLucideIcon("calendar-check-2", __iconNode$l4);
  ...
  const CalendarCheck = createLucideIcon("calendar-check", __iconNode$l3);
  ...
  const CalendarClock = createLucideIcon("calendar-clock", __iconNode$l2);
  ...
  const CalendarCog = createLucideIcon("calendar-cog", __iconNode$l1);
  ...
  const CalendarDays = createLucideIcon("calendar-days", __iconNode$l0);
  ...
  const CalendarFold = createLucideIcon("calendar-fold", __iconNode$k$);
  ...
  const CalendarHeart = createLucideIcon("calendar-heart", __iconNode$k_);
  ...
  const CalendarMinus2 = createLucideIcon("calendar-minus-2", __iconNode$kZ);
  ...
  const CalendarMinus = createLucideIcon("calendar-minus", __iconNode$kY);
  ...
  const CalendarOff = createLucideIcon("calendar-off", __iconNode$kX);
  ...
  const CalendarPlus2 = createLucideIcon("calendar-plus-2", __iconNode$kW);
  ...
  const CalendarPlus = createLucideIcon("calendar-plus", __iconNode$kV);
  ...
  const CalendarRange = createLucideIcon("calendar-range", __iconNode$kU);
  ...
  const CalendarSearch = createLucideIcon("calendar-search", __iconNode$kT);
  ...
  const CalendarSync = createLucideIcon("calendar-sync", __iconNode$kS);
  ...
  const CalendarX2 = createLucideIcon("calendar-x-2", __iconNode$kR);
  ...
  const CalendarX = createLucideIcon("calendar-x", __iconNode$kQ);
  ...
  const Calendar = createLucideIcon("calendar", __iconNode$kP);
  ...
  const CameraOff = createLucideIcon("camera-off", __iconNode$kO);
  ...
  const Camera = createLucideIcon("camera", __iconNode$kN);
  ...
  const CandyCane = createLucideIcon("candy-cane", __iconNode$kM);
  ...
  const CandyOff = createLucideIcon("candy-off", __iconNode$kL);
  ...
  const Candy = createLucideIcon("candy", __iconNode$kK);
  ...
  const Cannabis = createLucideIcon("cannabis", __iconNode$kJ);
  ...
  const CaptionsOff = createLucideIcon("captions-off", __iconNode$kI);
  ...
  const CarFront = createLucideIcon("car-front", __iconNode$kG);
  ...
  const CarTaxiFront = createLucideIcon("car-taxi-front", __iconNode$kF);
  ...
  const Car = createLucideIcon("car", __iconNode$kE);
  ...
  const Caravan = createLucideIcon("caravan", __iconNode$kD);
  ...
  const Carrot = createLucideIcon("carrot", __iconNode$kC);
  ...
  const CaseLower = createLucideIcon("case-lower", __iconNode$kB);
  ...
  const CircleDollarSign = createLucideIcon("circle-dollar-sign", __iconNode$js);
  ...
  const CircleHelp = createLucideIcon("circle-help", __iconNode$jl);
  ...
  const CirclePlus = createLucideIcon("circle-plus", __iconNode$jd);
  ...
  const CirclePoundSterling = createLucideIcon("circle-pound-sterling", __iconNode$jc);
  ...
  const Crop = createLucideIcon("crop", __iconNode$hx);
  ...
  const Dam = createLucideIcon("dam", __iconNode$hp);
  ...
  const Dribbble = createLucideIcon("dribbble", __iconNode$gH);
  ...
  const FerrisWheel = createLucideIcon("ferris-wheel", __iconNode$ge);
  ...
  const Figma = createLucideIcon("figma", __iconNode$gd);
  ...
  const FileArchive = createLucideIcon("file-archive", __iconNode$gc);
  ...
  const FileChartColumnIncreasing = createLucideIcon("file-chart-column-increasing", __iconNode$g4);
  ...
  const FileClock = createLucideIcon("file-clock", __iconNode$f$);
  ...
  const FileCode2 = createLucideIcon("file-code-2", __iconNode$f_);
  ...
  const FileDown = createLucideIcon("file-down", __iconNode$fV);
  ...
  const FileHeart = createLucideIcon("file-heart", __iconNode$fU);
  ...
  const FileImage = createLucideIcon("file-image", __iconNode$fS);
  ...
  const FileLock = createLucideIcon("file-lock", __iconNode$fM);
  ...
  const FileMinus = createLucideIcon("file-minus", __iconNode$fK);
  ...
  const FilePlus = createLucideIcon("file-plus", __iconNode$fE);
  ...
  const FileQuestion = createLucideIcon("file-question", __iconNode$fD);
  ...
  const FileScan = createLucideIcon("file-scan", __iconNode$fC);
  ...
  const FileSearch2 = createLucideIcon("file-search-2", __iconNode$fB);
  ...
  const FileVideo2 = createLucideIcon("file-video-2", __iconNode$fo);
  ...
  const FileX = createLucideIcon("file-x", __iconNode$fj);
  ...
  const FolderArchive = createLucideIcon("folder-archive", __iconNode$eS);
  ...
  const FolderCheck = createLucideIcon("folder-check", __iconNode$eR);
  ...
  const FolderClock = createLucideIcon("folder-clock", __iconNode$eQ);
  ...
  const FolderOpenDot = createLucideIcon("folder-open-dot", __iconNode$eC);
  ...
  const FolderOpen = createLucideIcon("folder-open", __iconNode$eB);
  ...
  const FolderSearch2 = createLucideIcon("folder-search-2", __iconNode$ew);
  ...
  const Framer = createLucideIcon("framer", __iconNode$ek);
  ...
  const GalleryHorizontalEnd = createLucideIcon("gallery-horizontal-end", __iconNode$ec);
  ...
  const Ghost = createLucideIcon("ghost", __iconNode$e2);
  ...
  const Gift = createLucideIcon("gift", __iconNode$e1);
  ...
  const GitPullRequestArrow = createLucideIcon("git-pull-request-arrow", __iconNode$dS);
  ...
  const GitPullRequestDraft = createLucideIcon("git-pull-request-draft", __iconNode$dO);
  ...
  const Grid3x2 = createLucideIcon("grid-3x2", __iconNode$dy);
  ...
  const Grid3x3 = createLucideIcon("grid-3x3", __iconNode$dx);
  ...
  const Ham = createLucideIcon("ham", __iconNode$dr);
  ...
  const Hamburger = createLucideIcon("hamburger", __iconNode$dq);
  ...
  const Hammer = createLucideIcon("hammer", __iconNode$dp);
  ...
  const HardDriveDownload = createLucideIcon("hard-drive-download", __iconNode$dh);
  ...
  const HardDriveUpload = createLucideIcon("hard-drive-upload", __iconNode$dg);
  ...
  const Heading3 = createLucideIcon("heading-3", __iconNode$d8);
  ...
  const HeadphoneOff = createLucideIcon("headphone-off", __iconNode$d3);
  ...
  const Import = createLucideIcon("import", __iconNode$ct);
  ...
  const LampCeiling = createLucideIcon("lamp-ceiling", __iconNode$c9);
  ...
  const MoveDown = createLucideIcon("move-down", __iconNode$9o);
  ...
  const MoveUpLeft = createLucideIcon("move-up-left", __iconNode$9m);
  ...
  const Parentheses = createLucideIcon("parentheses", __iconNode$8h);
  ...
  const Power = createLucideIcon("power", __iconNode$7n);
  ...
  const Rainbow = createLucideIcon("rainbow", __iconNode$74);
  ...
  const ReceiptText = createLucideIcon("receipt-text", __iconNode$6X);
  ...
  const Refrigerator = createLucideIcon("refrigerator", __iconNode$6I);
  ...
  const SaudiRiyal = createLucideIcon("saudi-riyal", __iconNode$68);
  ...
  const Scale = createLucideIcon("scale", __iconNode$64);
  ...
  const SearchSlash = createLucideIcon("search-slash", __iconNode$5M);
  ...
  const TabletSmartphone = createLucideIcon("tablet-smartphone", __iconNode$2O);
  ...
  const WrapText = createLucideIcon("wrap-text", __iconNode$8);
  ...
  const Zap = createLucideIcon("zap", __iconNode$3);
