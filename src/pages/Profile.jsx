    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
        <div 
          ...
          style={{ transform: `translate(${blobPositions.blob1.x}px, ${blobPositions.blob1.y}px)` }}
        />
        <div 
          ...
          style={{ transform: `translate(${blobPositions.blob2.x}px, ${blobPositions.blob2.y}px)` }}
        />
        <div 
          ...
          style={{ transform: `translate(${blobPositions.blob3.x}px, ${blobPositions.blob3.y}px)` }}
        />
      </div>
      ...
      <div className="fixed inset-0 pointer-events-none" aria-hidden="true">
        ...
        <div 
          ...
          style={{ transform: `translate(${-mousePosition.x * 0.012}px, ${-mousePosition.y * 0.012}px)` }}
        />
      </div>
      ...
      {/* Main Profile Content (existing code) */}
